...
void manageAlarm() {
  ...
  if (currentMillis - previousBuzzerMillis >= buzzerInterval) {
    ...
    digitalWrite(alarmLedPin, buzzerState ? HIGH : LOW);
  }
}
...
void logSensors() {
  ...
  String data = "GAS=" + String(gas) + ",FLAME=" + String(flame) + 
                ...
                ",TEMP=" + String(temperature) + ",HUM=" + String(humidity);

  Serial1.println("LOG;SENSORS;ALL;" + data);
  Serial.print("Sıcaklık: "); Serial.print(temperature);
  Serial.print("C, Nem: %"); Serial.println(humidity);
}
...
void openDoor() { keypadServo.write(180); }
void closeDoor() { 
  //keypadServo.write(0);
   }
...
void cardServoMove() {
  cardServo.write(180); delay(2000); cardServo.write(0); delay(500);
}
